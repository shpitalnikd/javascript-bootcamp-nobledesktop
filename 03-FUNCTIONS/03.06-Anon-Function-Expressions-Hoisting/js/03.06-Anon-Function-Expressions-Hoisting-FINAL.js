...
function doSomething() {
  output1.textContent = "btn1 click called the function doSomething()";
}
...
btn2.onclick = function () {
  output2.textContent = "btn2.onclick = anonymous function!";
};
...
btn3.addEventListener("click", function () {
  output3.textContent =
    "btn3 addEventListener('click', inline anonymous function)";
});
...
// 14. Have the body listen for the 'DOMContentLoaded' event, which fires when the body, is fully loaded, and to call a function when the loading of the page is complete:
// document.body.addEventListener('DOMContentLoaded', onBodyLoaded);

// function onBodyLoaded() {
//     alert('DOMContentLoaded event !! body loaded');
...
document.body.addEventListener("DOMContentLoaded", function (event) {
  output5.textContent =
    "HOLA HOW ARE YOU??? BODY LOADED says inline anonymous function";
});

// 16. Do away with the listener altogether, and instead use the onload event property to run the anonymous function:
// document.body.onload = function() {
//     output6.textContent = 'BODY LOADED says onload = anonymous function';
// };
